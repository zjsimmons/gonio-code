...
date_folder='2019_11_20/';

%tissue_types_cell_grid={'27_3';'27_4';'28_5';'28_6';'28_11';'28_13'}
tissue_types_cell_grid={'trial_1';'trial_2'}
...
%2019-11-20 suirrel set: 
file=dir(strcat('../../Data/survey/fresh_13LGS/',date_folder,tissue_type,'/','*gs_',num2str(file_n),'fw.mat'));
filename=strcat('../../Data/survey/fresh_13LGS/',date_folder,tissue_type,'/',file.name);
...
%squirrel set
file=dir(strcat('../../Data/survey/fresh_13LGS/',date_folder,tissue_type,'/','*gs_',num2str(file_n),'bw.mat'));
filename=strcat('../../Data/survey/fresh_13LGS/',date_folder,tissue_type,'/',file.name);
...
tag{1,2}=strcat('example set, fresh squirrel retina');
...
save(strcat('../../Data/survey/fresh_13LGS/',date_folder,tissue_type,'_',num2str(file_n),'.mat'),'g_traces','g_chart','tag');
...
save(strcat('../../Data/survey/fresh_13LGS/',date_folder,tissue_type,'_summary_weighted_fits.mat'),'g_traces_cube','g_chart_cube','tag');
